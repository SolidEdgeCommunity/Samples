...
<ComVisible(True), Guid("BF1C1BB8-75EE-444A-8DCE-0F1521D0764B"), ProgId("SolidEdgeCommunity.Samples.MyAddIn")> _
Public Class MyAddIn ' Solid Edge Shortcut Menu Events -  Solid Edge EC Events -  Solid Egde New File UI Events -  Solid Egde File UI Events -  Solid Edge Feature Library Events -  Solid Edge Window Events -  Solid Edge Application Events -  Solid Edge Community provided base class. -  Must be unique! -  Must be unique!
	...
	Private Shared Sub OnRegister(ByVal t As Type)
		Dim title As String = "SolidEdgeCommunity.Samples.MyAddIn"
		...
		Dim environments() As Guid = { SolidEdgeSDK.EnvironmentCategories.Application, SolidEdgeSDK.EnvironmentCategories.AllDocumentEnvrionments }
