...
Namespace ApiSamples.Samples.SolidEdge.Part
	''' <summary>
	''' Creates a new part and adds an extruded surface from a circle.
	''' </summary>
	Friend Class CreateExtrudedSurfaceByCircles2d
		Private Shared Sub RunSample(ByVal breakOnStart As Boolean)
			...
			Try
				...
				Dim ExtentType As SolidEdgePart.FeaturePropertyConstants
				Dim ExtentSide As SolidEdgePart.FeaturePropertyConstants
