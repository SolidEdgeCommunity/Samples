...
Namespace Part
	''' <summary>
	''' Creates a new part and adds a new chamfer using AddSetbackAngle().
	''' </summary>
	Friend Class CreateChamferByAddSetbackAngle
		Private Shared Sub RunSample(ByVal breakOnStart As Boolean)
			...
			Try
				...
				Dim dblAngle As Double = 45 * Math.PI / 180
				Dim setbackDistance As Double = 0.003175 ' 0.005;
				...
				chamfer = chamfers.AddSetbackAngle(ReferenceFace:= face, NumberOfEdgeSets:= edgeList.Count, EdgeSetArray:= edgeList.ToArray(), SetbackDistance:= setbackDistance, Angle:= dblAngle)
