...
'ORIGINAL LINE: this.closeAllDocumentsToolStripMenuItem.Click += new System.EventHandler(this.closeAllDocumentsToolStripMenuItem_Click);
			' 
...
'INSTANT VB NOTE: The following InitializeComponent event wireup was converted to a 'Handles' clause:
'ORIGINAL LINE: this.closeAllDocumentssilentToolStripMenuItem.Click += new System.EventHandler(this.closeAllDocumentssilentToolStripMenuItem_Click);
			' 
			' toolStripMenuItem1
			' 
...
'INSTANT VB NOTE: The following InitializeComponent event wireup was converted to a 'Handles' clause:
'ORIGINAL LINE: this.samplesForSolidEdgeToolStripMenuItem.Click += new System.EventHandler(this.samplesForSolidEdgeToolStripMenuItem_Click);
			' 
...
'INSTANT VB NOTE: The following InitializeComponent event wireup was converted to a 'Handles' clause:
'ORIGINAL LINE: this.interopForSolidEdgeToolStripMenuItem.Click += new System.EventHandler(this.interopForSolidEdgeToolStripMenuItem_Click);
			' 
...
'INSTANT VB NOTE: The following InitializeComponent event wireup was converted to a 'Handles' clause:
'ORIGINAL LINE: this.spyForSolidEdgeToolStripMenuItem.Click += new System.EventHandler(this.spyForSolidEdgeToolStripMenuItem_Click);
			' 
			' toolStripMenuItem2
			' 
...
'INSTANT VB NOTE: The following InitializeComponent event wireup was converted to a 'Handles' clause:
'ORIGINAL LINE: this.solidEdgeST6SDKToolStripMenuItem.Click += new System.EventHandler(this.solidEdgeST6SDKToolStripMenuItem_Click);
			' 
			' statusStrip
			' 
...
'INSTANT VB NOTE: The following InitializeComponent event wireup was converted to a 'Handles' clause:
'ORIGINAL LINE: this.buttonRun.Click += new System.EventHandler(this.buttonRun_Click);
			' 
			' buttonBreakpoint
			' 
...
'INSTANT VB NOTE: The following InitializeComponent event wireup was converted to a 'Handles' clause:
'ORIGINAL LINE: this.buttonBreakpoint.Click += new System.EventHandler(this.buttonBreakpoint_Click);
			' 
			' imageList
			' 
...
'INSTANT VB NOTE: The following InitializeComponent event wireup was converted to a 'Handles' clause:
'ORIGINAL LINE: this.treeView.AfterSelect += new System.Windows.Forms.TreeViewEventHandler(this.treeView_AfterSelect);
			' 
...
'INSTANT VB NOTE: The following InitializeComponent event wireup was converted to a 'Handles' clause:
'ORIGINAL LINE: this.listView.SelectedIndexChanged += new System.EventHandler(this.listView_SelectedIndexChanged);
			' 
			' columnHeader1
			' 
...
'INSTANT VB NOTE: The following InitializeComponent event wireup was converted to a 'Handles' clause:
'ORIGINAL LINE: this.backgroundWorker.DoWork += new System.ComponentModel.DoWorkEventHandler(this.backgroundWorker_DoWork);
'INSTANT VB NOTE: The following InitializeComponent event wireup was converted to a 'Handles' clause:
'ORIGINAL LINE: this.backgroundWorker.ProgressChanged += new System.ComponentModel.ProgressChangedEventHandler(this.backgroundWorker_ProgressChanged);
'INSTANT VB NOTE: The following InitializeComponent event wireup was converted to a 'Handles' clause:
'ORIGINAL LINE: this.backgroundWorker.RunWorkerCompleted += new System.ComponentModel.RunWorkerCompletedEventHandler(this.backgroundWorker_RunWorkerCompleted);
			' 
			' MainForm
			' 
