...
Namespace AddInDemo
	Friend Class MyViewOverlay
		...
		Public Overrides Sub BeginOpenGLMainDisplay(ByVal gl As IGL)
		...
		Private Sub DrawBoundingBox(ByVal gl As IGL)
		...
		Private Sub DrawCube(ByVal gl As SolidEdge.IGL, ByVal fSize As Single)
			Dim p0()() As Single = { _
