...
Namespace AddInDemo
	Friend Class PartRibbon
		Inherits SolidEdgeCommunity.AddIn.Ribbon

		Private Const _embeddedResourceName As String = "AddInDemo.PartRibbon.xml"
		...
		Private Function GetActiveOverlay() As MyViewOverlay
			Dim controlller = MyAddIn.Instance.ViewOverlayController
			Dim window = DirectCast(MyAddIn.Instance.Application.ActiveWindow, SolidEdgeFramework.Window)
			Dim overlay = DirectCast(controlller.GetOverlay(window), MyViewOverlay)
