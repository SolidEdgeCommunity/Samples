    ...
    class CreateStructuralFrame
    {
        static void RunSample(bool breakOnStart)
        {
            ...
            try
            {
                ...
                string filename = System.IO.Path.Combine(SolidEdgeCommunity.SolidEdgeInstall.GetInstalledPath(), @"Frames\DIN\I-Beam\I-Beam 80x46.par");
