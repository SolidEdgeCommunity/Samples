...
namespace ApiSamples
{
    partial class MainForm : Form
    {
        ...
        private void MainForm_Load(object sender, EventArgs e)
        {
            ...
            _assemblyMembers = DocReader.Read(Assembly.GetExecutingAssembly());
        ...
        {
            Type type = typeof(ApiSamples.Samples.SolidEdge.CloseAllDocuments);
        ...
        {
            Type type = typeof(ApiSamples.Samples.SolidEdge.CloseAllDocumentsSilent);
            MethodInfo method = type.GetMethod("RunSample", BindingFlags.Static | BindingFlags.NonPublic);
