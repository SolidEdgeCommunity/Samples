...
{
#pragma region CAddInRegistrar

	HRESULT CAddInRegistrar::Register(CLSID clsid, LPCTSTR description, LPCTSTR summary, ULONG cEnvironments, CATID environments[])
	{
		LCID lcid = GetSystemDefaultLCID();
		return CAddInRegistrar::Register(clsid, lcid, description, summary, cEnvironments, environments);
	}
