...
public:
	...
	HRESULT SetView(SolidEdgeFramework::WindowPtr pWindow);
	HRESULT SetView(SolidEdgeFramework::ViewPtr pView);
	HRESULT UnadviseFromEvents();

private:
	SolidEdgeFramework::ViewPtr m_pView;
...
protected:
	...
	class XViewEvents :
		public XEventHandler<ISEViewEvents, &__uuidof(ISEViewEvents), &LIBID_AddInDemoLib, XViewEvents, &CLSID_MyViewOverlayWindowEvents>
	{
	public:
	...
	class XhDCDisplayEvents :
		public XEventHandler<ISEhDCDisplayEvents, &__uuidof(ISEhDCDisplayEvents), &LIBID_AddInDemoLib, XhDCDisplayEvents, &CLSID_MyViewOverlayDCDisplayEvents>
	{
	public:
	...
	class XGLDisplayEvents :
		public XEventHandler<ISEIGLDisplayEvents, &__uuidof(ISEIGLDisplayEvents), &LIBID_AddInDemoLib, XGLDisplayEvents, &CLSID_MyViewOverlayGLDisplayEvents>
	{
	public:
